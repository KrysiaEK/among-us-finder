...
urlpatterns = [
	...
	path('delete_participant/<int:room_pk>/<int:user_pk>/', login_required(views.DeleteParticipant.as_view()), name='participant_delete'),
	path('join_error/<str:error_code>/', views.JoinRoomError.as_view(), name='join_room_error'),
	path('report_user/<int:user_pk>/<int:room_pk>/', login_required(views.ReportUserFormView.as_view()), name='report_user'),
